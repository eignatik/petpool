 ...
 *
 * <p><strong>Note:</strong> never input the real either encrypted or decrypted encryption encryptionKey in the application.
 * </p>
 */
public final class EncryptionTool {
    ...
    /**
     * The only constructor that takes the encryption encryptionKey once for encryption and decryption purposes.
     *
    ...
    private Key generateKey() {
        String decodedKey = new String(Base64.getDecoder().decode(encryptionKey.getBytes()), StandardCharsets.UTF_8);
